...
public class SignInActivity extends AppCompatActivity {
    ...
    private TextWatcher signInWatcher = new TextWatcher() {
        ...
        public void onTextChanged(CharSequence s, int start, int before, int count) {
            String emailInput = emailEditText.getText().toString().trim();//לוקח המחרוזת בלי רווחים
            String passwordInput = passwordEditText.getText().toString().trim();

            signInButton.setEnabled(!emailInput.isEmpty() && !passwordInput.isEmpty());//אם שני המלבנים לא רקים אז מאפשר לנו ללחוץ על הכפתור
    ...
    private void signIn(String json){
        try {
            ...
            //אם יש נתונים אז מכניס אותם לUSER
